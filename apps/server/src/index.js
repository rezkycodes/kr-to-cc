...
// The config UI builds Claude Code's base URL from this, so it must reflect the
// port Express actually bound — not the Host header of a proxying dev server.
app.set('gatewayPort', Number(PORT));
